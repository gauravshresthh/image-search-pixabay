		...
		<footer className='footer-1 bg-gray-100 py-8 sm:py-12'>
			<div className='container mx-auto px-4'>
				<div className='sm:flex sm:flex-wrap sm:-mx-4 md:py-4'>
					...
					<div className='px-4 sm:w-1/2 md:w-1/4 xl:w-1/6 mt-8 md:mt-0'>
						...
						<ul className='list-none footer-links'>
							<li className='mb-2'>
								<a
									href='https://shresthh-portfolio.netlify.app/'
									className='border-b border-solid border-transparent hover:border-purple-800 hover:text-purple-800'>
									Support
								</a>
							</li>
				...
				<div className='sm:flex sm:flex-wrap sm:-mx-4 mt-6 pt-6 sm:mt-12 sm:pt-12 border-t'>
					...
					<div className='px-4 sm:w-1/2 md:w-1/4 mt-4 md:mt-0'>
						<h6 className='font-bold mb-2'>Other Resources</h6>
						<p className='mb-4 text-green-800 text-sm uppercase underline '>
							<a
								className='font-bold'
								href='https://shresthh-portfolio.netlify.app/'>
								Go to my Resume
							...
							<a
								className='font-bold'
								href='https://gauravshresthh-portfolio.netlify.app/'>
								Go to terminal style Portfolio
							</a>
						</p>
					</div>
					<div className='px-4 md:w-1/4 md:ml-auto mt-6 sm:mt-4 md:mt-0'>
						<button className='px-4 py-2 bg-green-500 hover:bg-green-700 rounded text-white'>
							Get Started
						</button>
					</div>
				</div>
